(function () {
    function p() { this.c = "1264336722"; this.ca = "z"; this.Y = "line"; this.V = ""; this.X = "1"; this.D = "1589376905"; this.$ = "z1.cnzz.com"; this.W = ""; this.H = "CNZZDATA" + this.c; this.G = "_CNZZDbridge_" + this.c; this.O = "_cnzz_CV" + this.c; this.P = "CZ_UUID" + this.c; this.K = "UM_distinctid"; this.A = "0"; this.J = {}; this.a = {}; this.Ca() } function h(a,
        b) { try { if (Math.random() < .01) { var c = []; c.push("siteid=1264336722"); c.push("name=" + g(a.name)); c.push("msg=" + g(a.message)); c.push("r=" + g(l.referrer)); c.push("page=" + g(e.location.href)); c.push("agent=" + g(e.navigator.userAgent)); c.push("ex=" + g(b)); c.push("top=" + g(e.top === e ? 1 : 0)); c.push("ts=" + new Date().getTime()); c.push("rnd=" + Math.floor(2147483648 * Math.random())); (new Image).src = q + "//jserr.cnzz.com/log.php?" + c.join("&") } } catch (d) { } return !0 } var q = function () { for (var a = document.getElementsByTagName("script"), b = 0, c = a.length; b < c; b++) { var d, f = a[b]; if (f.src && (d = /^(https?:)\/\/[\w\.\-]+\.cnzz\.com\//i.exec(f.src))) return d[1] } return window.location.protocol }(),
